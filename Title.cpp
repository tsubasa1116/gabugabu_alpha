...
void Title_Draw()
{
	...
	// 属性アイコン（ロゴの後に左右からスライドイン）
	{
		...
		// 各アイコンの最終位置（画像の中心が画面の左右端ぴったり）
		XMFLOAT2 iconEndPos[4] = {
			{ 0.0f - 80,          SCREEN_HEIGHT * 0.55f },  // 電気：左端
			{ SCREEN_WIDTH - 120,  SCREEN_HEIGHT * 0.35f },  // 植物：右端
			{ 0.0f + 130,          SCREEN_HEIGHT * 0.75f },  // コンクリ：左端
			{ SCREEN_WIDTH - 140,  SCREEN_HEIGHT * 0.75f },  // ガラス：右端
		};
