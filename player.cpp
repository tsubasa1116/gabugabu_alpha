...
static void Player_DrawSilhouette(int p)
{
	...
	switch (p)
	{
	case 0: silhouetteColor  = { 0.64f,  0.2f, 0.2f, 0.8f }; break; // 赤
	case 1: silhouetteColor  = {  0.0f, 0.45f, 0.7f, 0.8f }; break; // 青
	case 2: silhouetteColor  = {  0.7f,  0.7f, 0.0f, 0.8f }; break; // 黄
	case 3: silhouetteColor  = {  0.0f,  0.6f, 0.0f, 0.8f }; break; // 緑
